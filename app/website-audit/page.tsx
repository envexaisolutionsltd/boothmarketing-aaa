...
export default function WebsiteAuditPage() {
  ...
  return (
    <main className="min-h-screen bg-[#090a0b] text-[#f4f4f3]">
      <header className="sticky top-0 z-40 border-b border-white/[0.06] bg-[#090a0b]/95 supports-[backdrop-filter]:bg-[#090a0b]/85 supports-[backdrop-filter]:backdrop-blur-xl"><div className="mx-auto flex min-h-[64px] w-[min(1080px,calc(100%-28px))] items-center justify-between gap-3"><Link href="/" className="inline-flex items-center gap-2 text-[12px] font-semibold text-[#d8cbb7]"><ArrowLeft className="h-4 w-4" />Home</Link><img src="/booth-marketing-logo.png" alt="Booth Marketing" className="w-[118px] sm:w-[145px]" /><Link href="/websites" className="text-[12px] font-semibold text-[#d8cbb7]">Websites</Link></div></header>
