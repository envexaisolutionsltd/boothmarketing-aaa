    ...
    <footer className="border-t border-white/[0.06] bg-[#090a0b]">
      <div className="mx-auto grid w-[min(1160px,calc(100%-28px))] gap-7 py-8 sm:grid-cols-[1.2fr_0.8fr] sm:items-end">
        <div>
          ...
          <p className="mt-2 max-w-md text-[11px] leading-5 text-[#707177]">Booth Marketing builds conversion-focused websites and automation systems for established businesses.</p>
        </div>
